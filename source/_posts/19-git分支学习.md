...
![image-20240112163700970](https://2c67fdf.webp.li/git分支1.png)
...
![image-20240112163806901](https://2c67fdf.webp.li/git分支2.png)
...
![image-20240112164615935](https://2c67fdf.webp.li/git分支3.png)
...
![image-20240112165005203](https://2c67fdf.webp.li/git分支4.png)
...
![image-20240112170153532](https://2c67fdf.webp.li/git分支5.png)
...
![image-20240112170846181](https://2c67fdf.webp.li/git分支6.png)

这个原因是由于我远程仓库中存在一些你本地没有的更改，因此无法直接推送。这种情况通常发生在两个不同的仓库试图推送到相同的引用（ref）上。这可能是由于其他仓库已经进行了更新并推送了这些更改，而你的本地仓库尚未获取这些更改。

![image-20240112171553559](https://2c67fdf.webp.li/git分支7.png)
