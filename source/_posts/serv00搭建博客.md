...
![xshell登录serv00](https://2c67fdf.webp.li/xshell登录serv00.png)
...
![typecho首页](https://2c67fdf.webp.li/typecho首页.png)

安装过程中唯一难度就是这个**数据库信息**，首先**网页登录**serv00，创建数据库。

![image-20250109104417180](https://2c67fdf.webp.li/serv00管理界面数据库配置.png)

然后把数据库信息填入 typecho 安装界面

![serv00配置信息填入typecho安装界面](https://2c67fdf.webp.li/serv00配置信息填入typecho安装界面.png)
