...
![nginx命令1](https://2c67fdf.webp.li/nginx命令1.png)

![nginx进程示意图](https://2c67fdf.webp.li/nginx进程示意图.png)
...
![nginx命令2](https://2c67fdf.webp.li/nginx命令2.png)
...
![关闭IIS服务](https://2c67fdf.webp.li/关闭IIS服务.png)

这时候在浏览器输入`localhost`就能跳转到nginx的默认界面。

![nginx命令3](https://2c67fdf.webp.li/nginx命令3.png)
...
![nginx命令4](https://2c67fdf.webp.li/nginx命令4.png)
